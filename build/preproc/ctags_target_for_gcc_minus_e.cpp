...
*/
# 270 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 302 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void LambdaTV(void)
{
    uint8_t x = 20;
    do
...
*/
# 334 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void bin_player(void)
{
    char data_read;
...
*/
# 412 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 477 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 595 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void time_update(void)
{
...
*/
# 640 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void web_introduce(void)
{
    char qrcode_buff[25];
...
*/
# 720 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void config(void)
{
...
*/
# 769 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void key_check(void)
{
    s_button.tick();
    c_button.tick();
...
*/
# 782 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 803 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 860 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 873 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
...
*/
# 894 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void setup(void)
{
    Serial.begin(115200);
...
*/
# 960 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV.ino"
void loop(void)
{
    select_menu();
}
# 1 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
# 2 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino" 2
...
*/
# 11 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
void s_click(void)
{
...
*/
# 24 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 36 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 49 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
void c_click(void)
{
...
*/
# 62 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 75 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 88 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 102 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 114 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 126 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
void key_init(void)
{
...
*/
# 143 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 160 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
*/
# 185 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_key.ino"
...
# 4 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino" 2
/*
...
*/
# 163 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void clock_mode()
{
    config_state = 0;
...
*/
# 212 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void instrustions(void)
{
    config_state = 16 * 3;
    if (config_state < config_last_state)
...
*/
# 245 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void clear_wifi(void)
{
    config_state = 16 * 2;
    if (config_state < config_last_state)
...
*/
# 278 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void config_about(void)
{
    config_state = 16 * 3;
    if (config_state < config_last_state)
...
*/
# 311 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void instrustions_enter(void)
{
...
*/
# 345 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void about_enter(void)
{
...
*/
# 374 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void clock_mode_enter(void)
{
    uint8_t mode = 0;
    uint8_t box_y = 0;
...
*/
# 447 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
...
*/
# 575 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void close_open_rgb(void)
{
    config_state = 16;
    if (config_state < config_last_state)
...
*/
# 608 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_menu.ino"
void close_open_rgb_enter(void)
{
    int8_t select = 0; //0 是取消，1是确认
    uint8_t show_flag = 0, frame_x = 0;
...
*/
# 33 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_server.ino"
...
*/
# 57 "f:\\ESP\\esp8266_oled\\LambdaTV\\LambdaTV_server.ino"
